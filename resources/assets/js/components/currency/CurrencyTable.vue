                ...
                <div class="table-scrollable">
                    <table class="table table-striped table-hover table-bordered dataTable no-footer"
                        ...
                        <tr role="row">
                            ...
                            <th tabindex="0" aria-controls="sample_editable_1" rowspan="1" colspan="1"
                                aria-label=" Full Name : activate to sort column ascending" style="width: 167px;">
                                Страны (коды стран разделенные знаком ^)
                            </th>
                            <th tabindex="0" aria-controls="sample_editable_1" rowspan="1" colspan="1"
                                aria-label="" style="width: 167px;">
                                Цена доставки
                            </th>
                            <th tabindex="0" aria-controls="sample_editable_1" rowspan="1" colspan="1"
                        ...
                        <currency-table-row
                                ...
                                v-bind:inputCurrency="currency"
                                v-on:remove="currencies.splice(index, 1)"
...
<script>
    export default {
        ...
        methods: {
            ...
            getData: function () {
                axios
                    .get('/root/currency/list', {params: {page: this.page, perPage: this.perPage}})
                    .then((response) => {
