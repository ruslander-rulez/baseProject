<template>
    ...
    <div class="portlet light bordered">
      <!--  <div class="portlet-title">
            ...
            <div class="table-toolbar">
                <div class="row">
                    <div class="col-md-12">
                     ...
                     <div class="col-md-6">
                        <div class="btn-group">
                            <button id="sample_editable_1_new" class="btn sbold green" v-on:click="showNewCategoryForm = true"> Новая категория
                    ...
                    <table class="table table-striped table-bordered table-hover table-checkable order-column dataTable no-footer"
                        ...
                        <tbody>
                            ...
                            <category-row
                                    ...
                                    v-bind:inputCategory="category"
                                    v-on:remove="categorys.splice(index, 1)"
        ...
        <category-edit v-if="showNewCategoryForm" v-on:close="showNewCategoryForm=false" :inputCategory="defaultCategory" v-on:created="created">
        </category-edit>
    </div>
...
<script>
    export default {
        ...
        methods: {
            ...
            created: function() {
                this.showAlert("Категория была создана")
                this.getData()
            },
            getData: function () {
                axios
                    .get('/root/category/list', {params: {page: this.page, perPage: this.perPage}})
                    .then((response) => {
