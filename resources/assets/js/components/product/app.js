...
Vue.component('product-table', require('./Table.vue'));
Vue.component('review-table', require('./review/Table.vue'));
Vue.component('product-row', require('./Row.vue'));
Vue.component('product-edit', require('./Edit.vue'));
